...
void SyncMgr::sync()
{
    ...
    BOOST_FOREACH( FolderInfo& m_dst, m_dst_list )
    {
        ...
        changed = m_sync.local_move_folders( m_src.base, m_src.folder_map,
        ...
        changed = m_sync.local_move_files( m_src.base, m_src.key_path_map,
        ...
        changed = m_sync.remote_copy_folders( m_src.base, m_src.folders_has_no_invalid,
        ...
        changed = m_sync.remote_copy_files( m_src.base, m_src.key_path_map,
                                            m_dst.base, m_dst.key_path_map );
        ...
        changed = m_sync.remove_folders( m_src.base, m_src.folders,
                                         m_dst.base, m_dst.folders );
        ...
        changed = m_sync.remove_files( m_src.base, m_src.files,
